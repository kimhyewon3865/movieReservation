                ...
                <div class="tabmenu">
                    ...
                    <div class="movie-list nano has-scrollbar-y" id="movie_list" style="height: 300px;">
                        <ul class="content scroll-y" onscroll="movieSectionScrollEvent();" tabindex="-1">
                            ...
                            <li class="rating-12" data-index="1" movie_cd_group="20012931" movie_idx="79673" onclick="setSelectedMovie(1)">
                                노무현입니다
                            </li>

                            <li class="rating-15" data-index="2" movie_cd_group="20012790" movie_idx="79622" onclick="setSelectedMovie(2)">
                                겟아웃
                            </li>
                        </ul>
                    </div>
            ...
            <div class="date-list nano has-scrollbar-y" id="date_list" style="height: 522px;">
                <ul class="content scroll-y" tabindex="-1">
                    <div>
                        ...
                        <%--<li data-index="2" date="20170527" class="day day-sat"><a href="#" onclick="return false;"><span class="dayweek">토</span><span class="day">27</span><span class="sreader"></span></a></li><li data-index="3" date="20170528" class="day day-sun"><a href="#" onclick="return false;"><span class="dayweek">일</span><span class="day">28</span><span class="sreader"></span></a></li><li data-index="4" date="20170529" class="day"><a href="#" onclick="return false;"><span class="dayweek">월</span><span class="day">29</span><span class="sreader"></span></a></li><li data-index="5" date="20170530" class="day"><a href="#" onclick="return false;"><span class="dayweek">화</span><span class="day">30</span><span class="sreader"></span></a></li><li data-index="6" date="20170531" class="day"><a href="#" onclick="return false;"><span class="dayweek">수</span><span class="day">31</span><span class="sreader"></span></a></li><li class="month dimmed"><div><span class="year">2017</span><span class="month">6</span><div></div></div></li><li data-index="7" date="20170601" class="day"><a href="#" onclick="return false;"><span class="dayweek">목</span><span class="day">1</span><span class="sreader"></span></a></li><li data-index="8" date="20170602" class="day"><a href="#" onclick="return false;"><span class="dayweek">금</span><span class="day">2</span><span class="sreader"></span></a></li><li data-index="9" date="20170603" class="day day-sat"><a href="#" onclick="return false;"><span class="dayweek">토</span><span class="day">3</span><span class="sreader"></span></a></li><li data-index="10" date="20170604" class="day day-sun"><a href="#" onclick="return false;"><span class="dayweek">일</span><span class="day">4</span><span class="sreader"></span></a></li><li data-index="11" date="20170605" class="day"><a href="#" onclick="return false;"><span class="dayweek">월</span><span class="day">5</span><span class="sreader"></span></a></li><li data-index="12" date="20170606" class="day"><a href="#" onclick="return false;"><span class="dayweek">화</span><span class="day">6</span><span class="sreader"></span></a></li><li data-index="13" date="20170607" class="day"><a href="#" onclick="return false;"><span class="dayweek">수</span><span class="day">7</span><span class="sreader"></span></a></li><li data-index="14" date="20170608" class="day"><a href="#" onclick="return false;"><span class="dayweek">목</span><span class="day">8</span><span class="sreader"></span></a></li><li data-index="15" date="20170609" class="day"><a href="#" onclick="return false;"><span class="dayweek">금</span><span class="day">9</span><span class="sreader"></span></a></li><li data-index="16" date="20170610" class="day day-sat"><a href="#" onclick="return false;"><span class="dayweek">토</span><span class="day">10</span><span class="sreader"></span></a></li><li data-index="17" date="20170611" class="day day-sun"><a href="#" onclick="return false;"><span class="dayweek">일</span><span class="day">11</span><span class="sreader"></span></a></li><li data-index="18" date="20170612" class="day"><a href="#" onclick="return false;"><span class="dayweek">월</span><span class="day">12</span><span class="sreader"></span></a></li><li data-index="19" date="20170613" class="day"><a href="#" onclick="return false;"><span class="dayweek">화</span><span class="day">13</span><span class="sreader"></span></a></li><li data-index="20" date="20170614" class="day"><a href="#" onclick="return false;"><span class="dayweek">수</span><span class="day">14</span><span class="sreader"></span></a></li><li class="month dimmed"><div><span class="year">2017</span><span class="month">7</span><div></div></div></li><li data-index="21" date="20170719" class="day"><a href="#" onclick="return false;"><span class="dayweek">수</span><span class="day">19</span><span class="sreader"></span></a></li><li class="month dimmed"><div><span class="year">2017</span><span class="month">8</span><div></div></div></li><li data-index="22" date="20170816" class="day"><a href="#" onclick="return false;"><span class="dayweek">수</span><span class="day">16</span><span class="sreader"></span></a></li>--%>
                    </div>
                </ul>
